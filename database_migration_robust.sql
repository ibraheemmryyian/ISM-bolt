-- =====================================================
-- ROBUST DATABASE MIGRATION FOR REAL DATA COLLECTION
...
-- ROBUST: Handles all edge cases and missing dependencies

-- =====================================================
-- PREREQUISITE: ENSURE COMPANIES TABLE EXISTS AND HAS PROPER STRUCTURE
-- =====================================================
...
BEGIN
    ...
    IF companies_exists THEN
        ...
        IF user_id_exists THEN
            ...
            END IF;
        ELSE
            RAISE NOTICE 'user_id column does not exist in companies table. Skipping foreign key constraints.';
        END IF;
    ELSE
        RAISE NOTICE 'companies table does not exist. Skipping foreign key constraints.';
    END IF;
END $$;

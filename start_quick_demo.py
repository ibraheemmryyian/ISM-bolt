#!/usr/bin/env python3
"""
Quick SymbioFlows Demo - Skips dependency installation for fast startup
"""
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('quick_demo.log', encoding='utf-8'),
...
print("🚀 SymbioFlows Quick Demo")
print("📝 Logging to: quick_demo.log")
print("⏰ Started at:", time.strftime("%Y-%m-%d %H:%M:%S"))
print("-" * 60)

class QuickDemoOrchestrator:
    """Quick demo orchestrator - skips dependency installation"""
    
    def __init__(self):
        logger.info("Initializing Quick Demo Orchestrator...")
    ...
    def start_services(self, available_tools):
        """Start services without dependency installation"""
        logger.info("Starting services (skipping dependency installation)...")
    ...
    def display_status(self, services, healthy_services):
        ...
        logger.info("\n" + "="*60)
        logger.info("SYMBIOFLOWS QUICK DEMO STATUS")
        logger.info("="*60)
    ...
    def run(self):
        """Main run method"""
        try:
            logger.info("Starting SymbioFlows Quick Demo System")
            logger.info("="*60)
            ...
            # Start services (skip dependency installation)
...
def main():
    """Main entry point"""
    print("🚀 SymbioFlows Quick Demo")
    print("📝 Check quick_demo.log for detailed logs")
    print("⏰ Started at:", time.strftime("%Y-%m-%d %H:%M:%S"))
    print("-" * 60)
    
    orchestrator = QuickDemoOrchestrator()

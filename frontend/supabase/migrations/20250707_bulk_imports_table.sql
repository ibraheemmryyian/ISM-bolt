...
ALTER TABLE companies ADD COLUMN IF NOT EXISTS data_quality_score INTEGER DEFAULT 0;
ALTER TABLE companies ADD COLUMN IF NOT EXISTS processing_status VARCHAR(50) DEFAULT 'pending';
ALTER TABLE companies ADD COLUMN IF NOT EXISTS enriched_data JSONB;
ALTER TABLE companies ADD COLUMN IF NOT EXISTS business_metrics JSONB;
ALTER TABLE companies ADD COLUMN IF NOT EXISTS ai_insights JSONB;
ALTER TABLE companies ADD COLUMN IF NOT EXISTS recommendations JSONB;
ALTER TABLE companies ADD COLUMN IF NOT EXISTS last_processed_at TIMESTAMP WITH TIME ZONE;
ALTER TABLE companies ADD COLUMN IF NOT EXISTS processing_errors JSONB;
...
-- Create view for high-value targets

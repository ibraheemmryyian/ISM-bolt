    ...
    try {
      ...
      setTimeout(() => {
        ...
        setAiMaterials([
          {
            id: '1',
            name: 'Steel Scrap (High Grade)',
            category: 'Metal Waste',
            description: 'Premium quality steel scrap suitable for recycling and reuse in manufacturing',
            quantity: '50 tons/month',
            frequency: 'Monthly',
            potential_value: '$125,000',
            quality_grade: 'high',
            potential_uses: ['Steel manufacturing', 'Construction materials', 'Automotive parts'],
            symbiosis_opportunities: ['Local steel mills', 'Construction companies', 'Automotive manufacturers'],
            ai_generated: true,
            sustainability_score: 92
          },
          {
            id: '2',
            name: 'Chemical Byproducts (Non-hazardous)',
            category: 'Chemical Waste',
            description: 'Safe chemical byproducts from production processes',
            quantity: '15 tons/month',
            frequency: 'Monthly',
            potential_value: '$45,000',
            quality_grade: 'medium',
            potential_uses: ['Water treatment', 'Fertilizer production', 'Textile processing'],
            symbiosis_opportunities: ['Water treatment plants', 'Agricultural companies', 'Textile manufacturers'],
            ai_generated: true,
          ...
          },
          {
            ...
            category: 'Energy',
            description: 'Waste heat from production processes available for district heating',
            quantity: '500 kW',
            frequency: 'Continuous',
            potential_value: '$75,000',
            quality_grade: 'high',
            potential_uses: ['District heating', 'Greenhouse operations', 'Industrial processes'],
            symbiosis_opportunities: ['District heating networks', 'Greenhouse farms', 'Nearby industries'],
            ai_generated: true,
        ...
        setAiMatches([
          {
            id: '1',
            company_name: 'Arabian Steel Solutions',
            company_type: 'Steel Manufacturing',
            location: 'Riyadh, Saudi Arabia',
            match_score: 94,
            material_match: 'Steel Scrap (High Grade)',
            potential_savings: '$85,000',
            carbon_reduction: '45 tons CO2',
            implementation_time: '2-3 months',
            contact_info: 'procurement@arabiansteel.com',
            ai_generated: true,
            sustainability_impact: 'High - Circular economy model',
            risk_level: 'low',
            partnership_type: 'Waste Exchange'
          },
          {
            id: '2',
            company_name: 'Gulf Chemical Industries',
            company_type: 'Chemical Processing',
            location: 'Jeddah, Saudi Arabia',
            match_score: 87,
            material_match: 'Chemical Byproducts',
            potential_savings: '$52,000',
            carbon_reduction: '28 tons CO2',
            implementation_time: '3-4 months',
            contact_info: 'supply@gulfchemical.com',
            ai_generated: true,
            sustainability_impact: 'Medium - Resource optimization',
            risk_level: 'low',
            partnership_type: 'Byproduct Exchange'
          },
          {
            id: '3',
            company_name: 'Dubai District Heating',
            company_type: 'Energy Services',
            location: 'Dubai, UAE',
            match_score: 91,
            material_match: 'Heat Recovery System',
            potential_savings: '$68,000',
            carbon_reduction: '62 tons CO2',
            implementation_time: '4-6 months',
            contact_info: 'partnerships@dubaiheating.com',
            ai_generated: true,
            sustainability_impact: 'Very High - Renewable energy',
            risk_level: 'low',
            partnership_type: 'Energy Exchange'
          }
        ]);

        setAiAnalysis({
          symbiosis_score: 89,
          estimated_savings: '$2,450,000',
          carbon_reduction: '1,250 tons CO2',
          top_opportunities: ['Steel Scrap Recycling', 'Heat Recovery', 'Chemical Byproduct Exchange'],
          recommended_partners: ['Arabian Steel Solutions', 'Dubai District Heating', 'Gulf Chemical Industries'],
          implementation_roadmap: [
            'Review and approve AI-generated materials',
            'Select preferred partner matches',
            'Contact potential partners',
            'Establish supply agreements',
            'Implement logistics and monitoring'
          ],
          market_analysis: {
            demand_trend: 'Increasing (+15% YoY)',
            price_trend: 'Stable with upward pressure',

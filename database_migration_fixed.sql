-- =====================================================
-- FIXED DATABASE MIGRATION FOR REAL DATA COLLECTION
...
-- FIXED: Handles user_id column dependencies properly

-- =====================================================
-- PREREQUISITE: ENSURE COMPANIES TABLE HAS USER_ID
-- =====================================================
...
CREATE TABLE IF NOT EXISTS ai_insights (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    company_id UUID, -- Remove foreign key constraint for now
